...
* url 1..1 url "url" "Manifest URL for the SMART Health Link."
...
* key 1..1 string "key" "Encryption key"
...
* exp 0..1 string "exp" "Expiration time"
...
* v 0..1 integer "v" "Protocol version"
